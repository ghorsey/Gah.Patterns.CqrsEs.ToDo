namespace Gah.Patterns.ToDo.Api.Data.Migrations.EventStore
{
    ...
    /// <summary>
    /// Class <c>InitialEventStoreDbMigration</c>.
    /// Implements the <see cref="Microsoft.EntityFrameworkCore.Migrations.Migration" />
    /// </summary>
    /// <seealso cref="Microsoft.EntityFrameworkCore.Migrations.Migration" />
    public partial class InitialEventStoreDbMigration : Migration
    {
        /// <summary>
        /// <para>
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stream = table.Column<string>(maxLength: 2000, nullable: false),
                    EventNumber = table.Column<long>(nullable: false),
                    Event = table.Column<string>(nullable: false),
                    EventType = table.Column<string>(maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ES_EventStore", x => x.Id);
                    table.UniqueConstraint("AK_ES_EventStore_Stream_EventNumber", x => new { x.Stream, x.EventNumber });
                });
        }
